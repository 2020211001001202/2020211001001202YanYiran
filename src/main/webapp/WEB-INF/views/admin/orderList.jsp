			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.YanYiran.model.Order o=(com.YanYiran.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.YanYiran.dao.UserDao userDao=new com.YanYiran.dao.UserDao();
						...
						<%
							...
							String paymentType=com.YanYiran.model.Payment.findByPaymentId(con,n);
							 %>
