			...
			<h2><a href="<%=basePath%>shop">Click here to Continue shopping</a></h2>
					...
					<!-- loop_start -->
						...
						<tr>
							...
							<td class="cart_price"><p>${c.product.productName}</p></td>
							<td class="cart_price"><p>${c.quantity}</p></td>
							<td class="cart_total">
							
								<p id="total" class="cart_total_price">${c.quantity*c.product.price}</p></td>
