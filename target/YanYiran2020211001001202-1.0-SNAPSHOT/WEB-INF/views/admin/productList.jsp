<%@ page import="com.YanYiran.model.Product" %>
<%@ page import="com.YanYiran.model.Category" %>
		...
		<h2 class="title text-center">Product <strong>List</strong></h2> 
					...
					<c:forEach var="p" items="${productList}">
						...
						<tr>
							...
							<%
								 com.YanYiran.model.Product p=(com.YanYiran.model.Product)pageContext.findAttribute("p");
